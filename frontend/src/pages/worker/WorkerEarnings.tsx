  ...
  return (
    <div className="app-container with-bottom-nav">
      <main style={{ padding: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '80vh' }}>
        <IndianRupee size={48} className="text-primary mb-4" />
        <h2 style={{ fontSize: '20px', fontWeight: 600 }}>Earnings & Payouts</h2>
        <p className="text-muted text-center mt-2">View your detailed transaction history here.</p>
      </main>
